...
# about your device
export DEVICE="Symphony_Z50"
export DT_LINK="https://github.com/zobaermd620/twrp-symphonyz50" # device tree link
export DT_BRANCH="twrp" # device tree branch
export VENDOR="symphony" # device manufacturer or vendor
